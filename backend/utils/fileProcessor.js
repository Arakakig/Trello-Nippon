          ...
          if (value && value.toString().trim() !== '') {
            ...
            if (!isNaN(dateStr) && dateStr.includes('.')) {
              ...
              if (excelDate > 25569) { // Data válida do Excel (após 1970)
                ...
                if (!isNaN(date.getTime())) {
                  ...
                  console.warn(`Data inválida do Excel: ${dateStr}`);
                  value = '';
                }
              } else {
                console.warn(`Serial number muito baixo: ${dateStr}`);
                value = '';
              }
            }
            // Verificar se é formato brasileiro DD/MM/YYYY
              ...
              if (parts[0].length === 2 && parts[1].length === 2 && parts[2].length === 4) {
                // Formato DD/MM/YYYY - criar data corretamente
                ...
                if (day >= 1 && day <= 31 && month >= 0 && month <= 11 && year >= 1900 && year <= 2100) {
                  ...
                  console.warn(`Valores de data inválidos: ${dateStr}`);
                  value = '';
                }
              } else {
                ...
                if (!isNaN(date.getTime())) {
                  ...
                  console.warn(`Data inválida no formato padrão: ${dateStr}`);
                  value = '';
                }
              }
            } else {
